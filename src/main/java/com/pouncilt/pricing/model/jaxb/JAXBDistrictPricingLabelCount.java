...
import com.pouncilt.pricing.model.jaxb.adapters.JAXBStorePricingLabelCountMapAdapter;
...
public class JAXBDistrictPricingLabelCount implements LabelCountTree {
    ...
    @XmlElement(namespace = "http://www.pouncilt.com/pricing/pricinglabels/model", name = "storePricingLabelCounts")
